...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let buttonMessaged = {
                ...
                footer: ` Session bY >> ᴛᴇᴀᴍ ꜱɪᴛʜᴜᴡᴀ`,
                headerType: 4,
                contextInfo: {
                    externalAdReply: {
