     ...
     //if(!Number.isInteger(text.split(':')[1])) return citel.reply(`Please provide correct form.\nEg: setmute ${prefix}22:00`)
           let Group = await sck.findOne({ id: citel.chat })
             if (!Group) {
                 ...
                 return citel.reply(`_⚠️ Mute added for ${text} successfully._`)     
             }      
 }
 )
   ...
   // if(!Number.isInteger(text.split(':')[1])) return citel.reply(`Please provide correct form.\nEg: setmute ${prefix}22:00`)
          let Group = await sck.findOne({ id: citel.chat })
            if (!Group) {
                ...
                return citel.reply(`_⚠️ Unmute updated for ${text} successfully._`)
    ...
    if(!citel.isGroup) return citel.reply(tlang().group)
          let Group = await sck.findOne({ id: citel.chat })
            if (!Group) {return citel.reply('There\'s no unmute set in group.') }
                ...
                return citel.reply('⚠️ Unmute deleted successfully.')
    ...
    if(!citel.isGroup) return citel.reply(tlang().group)
          let Group = await sck.findOne({ id: citel.chat })
            if (!Group) { return citel.reply('There\'s no mute set in group.') }
                ...
                return citel.reply('⚠️ Mute deleted successfully.')
