...
else { var json = JSON.parse(fs.readFileSync('./Themes/sithuwa-md.json'));}	
...
function tlang() {  let LangG = getString("sithuwa-md");  return LangG;  }	

 function botpic() {	
 return new Promise( (resolve, reject) => {	
   let LangG = getString("sithuwa-md");	
